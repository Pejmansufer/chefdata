...
class Magmodules_Reviewemail_Block_Adminhtml_Widget_Info_Info extends Mage_Adminhtml_Block_Abstract implements Varien_Data_Form_Element_Renderer_Interface {
		...
		$html = '<div style="background:url(\'http://www.magmodules.eu/_logo.png\') no-repeat scroll 15px center #EAF0EE;border:1px solid #CCCCCC;margin-bottom:10px;padding:10px 5px 5px 200px;">
					...
					<table width="525" border="0">
						...
						<tr>
							...
							<td><strong><a href="http://www.magmodules.eu/help/product-review-reminder" target="_blank">Online manual</a></strong></td>
						</tr>
					</table>
				</div>';
		return $html;
