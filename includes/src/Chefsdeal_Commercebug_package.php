...
class Commercebug_Packager
{
    ...
    {
        $string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Chefsdeal_Commercebug><active>true</active><codePool>local</codePool></Chefsdeal_Commercebug></modules></config>';
        $string = str_replace('Chefsdeal_', $this->namespace . '_',$string);
