        ...
        foreach ($children as $child) {
            ...
            //if (true) {
                ...
                if (Mage::getStoreConfig('custom_menu/general/non_breaking_space')) $name = str_replace(' ', '&nbsp;', $name);
                    ...
                    $html.= '<div class="col-sm-2"><a href="' . $this->getCategoryUrl($child) . '"><div class="dd-menu-inner"><img class="img-responsive" src="/media/catalog/category/' . $image . '" alt="' . $name . '"></div><div class="row">' . $name . '</div></a></div>';
                    $tmp++;
