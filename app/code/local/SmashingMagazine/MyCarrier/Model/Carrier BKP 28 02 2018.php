    ...
    {		
        ...
        if ($request->getAllItems()) {
            foreach ($request->getAllItems() as $item) {
				...
				else if(($productObj->getWeight() >= 50 && $productObj->getData('shipping_method') != 'ups') || $productObj->getData('shipping_method') == 'freight')
                {
    ...
    protected function _getFreightRate(Mage_Shipping_Model_Rate_Request $request)
    {
        ...
        if ($request->getAllItems()) {
            foreach ($request->getAllItems() as $item) {
                ...
                else if (($productObj->getWeight() < 50 && ($productObj->getData('shipping_method') != 'freight') || $productObj->getData('shipping_method') == 'ups')) {
					$this->UpsAvailable = true;
                    continue;
                }
