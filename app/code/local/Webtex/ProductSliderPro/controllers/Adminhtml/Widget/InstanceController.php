...
class Webtex_ProductSliderPro_Adminhtml_Widget_InstanceController extends Mage_Adminhtml_Controller_Action
{
    public function productsproAction()
    {
        ...
        $chooser = $this->getLayout()
            ->createBlock('productsliderpro/adminhtml_catalog_product_widget_chooser')
