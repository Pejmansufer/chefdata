...
*/
class Chefsdeal_Commercebug_Model_Collectorblocksandlayout extends Chefsdeal_Commercebug_Model_Observingcollector
{
    ...
    {		
        ...
        foreach($this->_blocks as $block)
        {
            ...
            if(strpos($class,'Chefsdeal_Commercebug') === 0)
            {
                continue;
            }
