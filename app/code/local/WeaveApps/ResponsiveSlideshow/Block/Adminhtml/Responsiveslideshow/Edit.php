 ...
 *
 */
class WeaveApps_ResponsiveSlideshow_Block_Adminhtml_Responsiveslideshow_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        if( Mage::registry('responsiveslideshow_data') && Mage::registry('responsiveslideshow_data')->getId() ) {
            return Mage::helper('responsiveslideshow')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('responsiveslideshow_data')->getTitle()));
        } else {
