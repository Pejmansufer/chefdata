 ...
 */
class MS_ProductDetailShipping_Block_Estimate_Form extends MS_ProductDetailShipping_Block_Estimate_Abstract
{
    /**
    ...
    {
        return $this->getUrl('ms_productdetailshipping/estimate/estimate', array('_current' => true));
    }
