        ...
        for ( var i = 0; i < index.length; i++ ) {
            ...
            //if ( level < currentLevel ||  options[i][2] > 0 ) {
                ...
                if ( subCategory.getItemsQty() ) {
                    if ( selected ) {
                        html +='<strong>' + subCategory.getTitle() + '</strong>';
                    } else {
                        html += '<a href="#" rel="value:' + subCategory.getId() + '">' + subCategory.getTitle() + '</a>';
                    }
                } else {
                    html += subCategory.getTitle();
                }
                html +=' (' + subCategory.getItemsQty() + ')';
