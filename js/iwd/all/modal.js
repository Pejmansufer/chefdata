+function($){'use strict';var ModalIWD=function(element,options){this.options=options
...
else if(options.show)data.show(_relatedTarget)})}var old=$.fn.modaliwd
$.fn.modaliwd=Plugin
...
Plugin.call($target,option,this)})}(jQueryIWD);